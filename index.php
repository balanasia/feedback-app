...
<?php
  //shorthand for setting each of the value to null
  $name = $email = $body = '';
...
?>
    ...
    <img src="img/logo.png" class="w-25 mb-3" style="height:10%" alt="">
    <h2>Feedback</h2>
    <p class="lead text-center">Leave feedback for Anastasiia Balakhan</p>
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST" class="mt-4 w-75">
      <div class="mb-3">
        <label for="name" class="form-label">Name</label>
        <!-- conditinal based on if the name is input or not -->
